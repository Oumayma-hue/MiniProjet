...
public class AccountController {
	...
	public String createAccountForm(@PathVariable int idPerson, Model model) {
		//On crée le model 
		AccountModel accountModel = new AccountModel((long) idPerson);
	...
	@RequestMapping("deliberation")
	public String deliberation(Model model) {
	...
	@PostMapping("exportdeliberation")
    public void exportdeliberation(HttpServletResponse response,@RequestParam(name="idNiveau") Long idNiveau) throws IOException{
		response.setContentType("application/octet-stream");
